...
printf("\n%s", *pp);
 ...
 printf("\n%s", *(pp + 4));
  ...
  /***** print the substring of pointee of the 5th element pointer (i.e., string "iter"), using both array index notation  and pointer notation, */
 ...
 /* pure pointer notation, for those who love Pointer to Pointer :-) */
